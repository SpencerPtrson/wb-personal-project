...
export default function EditPokemonInstancePage() {
  ...
  const { pokemonInstance, speciesList, movesList, abilityList } = useLoaderData();
  ...
  return (
    <>
      ...
      <EditPokemonInstanceForm pokemonInstance={pokemonInstance} speciesList={speciesList} movesList={movesList} abilityList={abilityList} editPokemonFunction={handleEditPokemon}/>
    </>
  );
}
